...
export default defineConfig({
  ...
  head: [
    [
      "link",
      {
        ...
        sizes: "180x180",
        href: "/FxKit/apple-touch-icon.png",
      },
    ],
    [
      "link",
    ...
    [
      "meta",
      { property: "og:url", content: "https://taxfyle.github.io/FxKit/" },
    ],
  ],
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Transformer Generator", link: "/compiler/transformer" },
        ],
      },
      {
        text: "Testing",
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/taxfyle/FxKit" }],
    footer: {
