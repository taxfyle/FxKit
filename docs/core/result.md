...
way to handle these outcomes explicitly, avoiding throwing exceptions. Exceptions aren't are not good to
report failures, because exception aren't part of methods signature and compiler doesn't help tracking
