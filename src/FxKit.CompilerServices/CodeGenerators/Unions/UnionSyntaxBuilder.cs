...
internal static class UnionSyntaxBuilder
{
    ...
    public static string GenerateUnionMembers(UnionGeneration union)
    {
        ...
        sb.AppendLine("using System;");                          // Needed for Func
        sb.AppendLine("using System.Diagnostics;");              // Needed for [DebuggerHidden]
        sb.AppendLine("using System.Diagnostics.CodeAnalysis;"); // Needed for [ExcludeFromCodeCoverage]
        sb.AppendLine("using System.Runtime.CompilerServices;"); // Needed for [MethodImpl]
        ...
        UnionConstructor constructor)
    {
        ...
        foreach (var param in constructor.Parameters)
        {
            ...
            sb.Append(param.FullyQualifiedTypeName).Append(' ').Append(param.Identifier);
    ...
    /// <param name="sb"></param>
    /// <param name="union"></param>
    private static void PrintUnionMatchMethod(StringBuilder sb, UnionGeneration union)
    {
