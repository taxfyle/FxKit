...
//
// Modified for FxKit to comply with style.
...
/// <summary>
///     A polyfill for HashCode.
/// </summary>
internal struct HashCode
{
    private static readonly uint globalSeed = GenerateGlobalSeed();
...
#pragma warning disable RS1035 // this is fine
...
#pragma warning restore RS1035
    ...
    {
        v1 = globalSeed + Prime1 + Prime2;
        v2 = globalSeed + Prime2;
        v3 = globalSeed;
        v4 = globalSeed - Prime1;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static uint Round(uint hash, uint input)
    {
        return RotateLeft(hash + input * Prime2, offset: 13) * Prime1;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static uint QueueRound(uint hash, uint queuedValue)
    {
        return RotateLeft(hash + queuedValue * Prime3, offset: 17) * Prime4;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static uint MixState(uint v1, uint v2, uint v3, uint v4)
    {
        return RotateLeft(v1, offset: 1) + RotateLeft(v2, offset: 7) + RotateLeft(v3, offset: 12) + RotateLeft(v4, offset: 18);
    }
